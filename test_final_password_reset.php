<?php
// Final test of password reset functionality after collation fix
...
try {
    ...
    echo "=== Final Password Reset Test After Collation Fix ===\n";
    
    // Check collations first
    ...
    echo "✓ Collation mismatch has been resolved!\n";
