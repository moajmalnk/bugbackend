...
class BugDocsController extends BaseAPI {
     ...
     *
     * @param array $rows Documents with project_id / project_name
     * @return array
     */
     ...
     * @return array Document details with URL
     */
    public function createGeneralDocument($userId, $docTitle, $templateId = null, $docType = 'general', $projectId = null, $role = 'all', $allowedUserIds = null, $googleAccountUserId = null) {
        try {
    ...
    public function listUserDocuments($userId, $includeArchived = false, $projectId = null) {
        try {
            ...
            $documents = $this->hydrateProjectNames($documents);
